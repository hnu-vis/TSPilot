...
- `source_type: Literal["query", "statistics", "insight", "forecast", "anomaly", "rag", "skill"]`
- `source_id: str | null`
- `label: str`
- `evidence: dict | null`
...
- `sections` may carry structured payloads such as verified insight ids and visualization ids
- `references` must point to grounded evidence or insights
- `source_id` should point to a stable runtime artifact id such as `evidence_id`, `insight_id`, `forecast_id`, or `anomaly_id`
