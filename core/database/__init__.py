...
class ConnectorFactory:
    ...
    _CONNECTORS = {
        ...
        DatabaseType.GREPTIMEDB: (GreptimeDBConnector, GreptimeDBConfig),
        DatabaseType.TDENGINE: (TDengineConnector, TDengineConfig),
        DatabaseType.CNOSDB: (CnosDBConnector, CnosDBConfig),
        DatabaseType.ARCADEDB: (ArcadeDBConnector, ArcadeDBConfig),
        DatabaseType.CRATEDB: (CrateDBConnector, CrateDBConfig),
        DatabaseType.DRUID: (DruidConnector, DruidConfig),
