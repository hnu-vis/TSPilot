...
class LLMQueryGenerator:
    ...
    def _system_prompt(self, *, database_type: str, response_language: str = "en") -> str:
        ...
        return prompt_locale_instruction(response_language) + (
            ...
            "and do not aggregate, rank, group, join, pivot, LIMIT/head/tail, or compute derived outputs in the query. "
            "This raw analysis-evidence contract overrides constraints.max_points; max_points limits prompt or presentation payloads, not the persisted rows used by anomaly, forecast, or code_interpreter. "
