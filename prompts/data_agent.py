...
class DataAgentPromptBuilder:
    ...
    def _compact_system_prompt(self) -> str:
        return (
            ...
            "unavailable_outputs and unavailable_reason are status metadata, never presentation sources. When no visualization_id was returned, keep response_plan.visualization_ids empty and do not place phrases such as 'visualization unavailable' in any section source_refs. "
            ...
            "Every section source_ref must be copied verbatim from state.artifacts.refs, state.insight_state, or a successful visualization observation; explanatory labels and availability states are not refs. "
